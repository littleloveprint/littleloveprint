...
<html>
	...
	<body>
		...
		<main>
			...
			<h3>Purpose:</h3>
			<p>The purpose of my PWP is to create an informative, visually appealing site to showcase my talents and abilities in order to procure freelance or permanent work.</p>
			<h3>Audience:</h3>
			...
			<p><strong>Profession: </strong>Personal fitness trainer, food and beer enthusiast, social butterfly.</p>
			<p><strong>Technology: </strong>All Apple everything; MacBook Pro, iPhone, iPad, and Apple Watch.</p>
			<p><strong>Attitudes and Behaviors: </strong>Nakeesia loves training both indoor and out in nature. She is very accommodating to her clients and will meet them wherever it is convenient for them. She always puts her clients first, so this means she is constantly on the move.</p>
