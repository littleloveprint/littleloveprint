...
try {
	 ...
	 * Here, we set two versions of the message: the HTML formatted message and a special filter_var()ed version of the message that generates a plain text version of the HTML content.
	 * Notice one tactic used is to display the entire $confirmLink to plain text; this lets users who aren't viewing HTML content in Emails still access your links.
	 **/
	...
	echo "<div class=\"alert alert-success\" role=\"alert\">Your email has been sent! Lea will respond to you shortly.</div>";
